...
const schema = zod.object({
  ...
  otp: zod
    .string()
    .min(1, { message: "OTP must be at least 1 character long" }),
});
              ...
              {otpSent ? (
                <div className="mb-3">
                  <button
                    ...
                    onClick={sendOtp}
                  >
                    {sendOtpLoading ? "Sending..." : "Re-Send OTP"}
                  </button>
                </div>
              ) : (
                <div className="mb-3">
              ...
              {otpSent && (
                <>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    {nameError && (
                      <p className="text-danger mt-1">{nameError}</p>
                    )}
                  </div>
                  <div className="mb-3">
                    <PhoneInput
                    ...
                    />
                    {phoneError && (
                      <p className="text-danger mt-1">{phoneError}</p>
                    )}
                  </div>
                  <div className="mb-3">
                    <div className=" d-flex  password-form-control">
                      <input
